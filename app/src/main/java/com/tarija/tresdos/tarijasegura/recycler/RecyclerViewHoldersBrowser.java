...
public class RecyclerViewHoldersBrowser extends RecyclerView.ViewHolder implements View.OnClickListener {

    public TextView txtUrlName, create_at;
    public Button btnGo, btnDelete;
    public ItemClickListerner itemClickListerner;

    public RecyclerViewHoldersBrowser(View itemView) {
        super(itemView);
