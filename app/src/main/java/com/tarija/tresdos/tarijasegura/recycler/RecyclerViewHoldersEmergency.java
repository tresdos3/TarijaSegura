...
public class RecyclerViewHoldersEmergency extends RecyclerView.ViewHolder implements View.OnClickListener {

    public ImageView ImgIcon;
    public TextView txtOption, txtDescription;
    public ItemClickListerner itemClickListerner;

    public RecyclerViewHoldersEmergency(View itemView) {
        super(itemView);
